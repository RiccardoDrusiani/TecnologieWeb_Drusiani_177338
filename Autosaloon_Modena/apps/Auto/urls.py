...
from .views import (
    ...
    AutoDetailView, user_autos_view, AffittaAutoRiepilogoView, contrattazione_auto_view
)
...
urlpatterns = [
    ...
    path('<int:pk>/contrattazione-negoziazione/', contrattazione_auto_view, name='contrattazione_auto'),
]
